...
__global__ void pdpancrN(const int M,
                         const int NB,
                         const int JB,
  ...
  if (block==0) {
    ...
    for (int jj = 0; jj < JB; ++jj) {
      ...
      if (t<NB) {
        if (JJ + jj + 1 < t && t < JJ + JB) {
          //apply all updates to the rest of this row of L1
...
void HPL_pdpancrN(HPL_T_panel* PANEL,
  ...
  if (M>0) {
    ...
    void* params[] = {&m,
                      ...
                      &host_flag,
                      &barrier};
    CHECK_HIP_ERROR(hipLaunchCooperativeKernel(pdpancrN<BLOCKSIZE>,
                                               dim3(Nblocks),
                                               dim3(BLOCKSIZE),
                                               params,
                                               0,
